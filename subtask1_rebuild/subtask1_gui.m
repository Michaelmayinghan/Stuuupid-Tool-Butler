...
% Prefer rebuild versions in this folder and its subfolders.
...
if nargout == 0
    ...
    function onRunQuery()
        ...
        for r = 1:size(result.metaRows,1)
            app.metricsRows(end+1, :) = {stamp, qText, result.metaRows{r,1}, result.metaRows{r,2}, sprintf('%.3f', elapsedMs), approxBytes, result.metaRows{r,3}}; %#ok<AGROW>
        end
